...
import { handleErrorValidator, validateRequest } from "@/middleware/validator/handleErrorExpressValidator";

const router = Router()

router.put('/', tokenVerify, uploader, VerifiyAccountValidator, validateRequest, VerifiedUserAccount)
